                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              <img height="auto" src="{{ asset('frontend/images/logo_nomads@2x.png') }}"
                        ...
                        <tbody>
                          <tr>
                            <td style="width:550px;">
                              <img height="auto"
                                src="{{ asset('storage/' . $data->travel_package->galleries[0]->image) }}"
                                style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                                width="550" />
                            </td>
                          </tr>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" border="0"
                        ...
                        <tr>
                          ...
                          <td
                            ...
                            support@granitebps.com <br /> 021-4220625 </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
