            ...
            <div class="row">
                    ...
                    <div class="card card-details mb-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            {{ \Carbon\Carbon::parse($detail->doe_passport) > \Carbon\Carbon::now() ? 'Active' : 'Inactive' }}
                                        </td>
                                        <td class="align-middle">
                                            <a href="{{ route('checkout-remove', ['detail_id' => $detail->id]) }}">
                                                <img src="{{ asset('frontend/images/icon_remove.png') }}" alt="Remove"
                                                    height="18" />
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method="POST"
                                ...
                                <input name="username" type="text" class="form-control mb-2 mr-sm-2" id="username"
                                    placeholder="Username" required />

                                <label for="nationality" class="sr-only">Nationality</label>
                                <input name="nationality" type="text" class="form-control mb-2 mr-sm-2" id="nationality"
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <img src="{{ asset('frontend/images/gopay.png') }}" alt="" class="w-50">
                    </div>

                    <div class="join-container">
                        <a href="{{ route('checkout-success', ['id' => $item->id]) }}"
                            class="btn btn-block btn-join-now mt-3 py-2">Process Payment</a>
                    </div>
                    <div class="text-center mt-3">
                        <a href="{{ route('detail', ['slug' => $item->travel_package->slug]) }}"
                            class="text-muted">Cancel Booking</a>
                    </div>
                </div>
            </div>
        </div>
