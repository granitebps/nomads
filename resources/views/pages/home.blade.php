...
<header class="text-center">
    ...
    <a href="#popular" class="btn btn-get-started px-4 py-2 mt-4">Get Started</a>
</header>

<main>
    <div class="container">
        <section class="section-stats row justify-content-center" id="stats">
            <div class="col-md-2 col-6 stats-detail">
                <h2>20K</h2>
                <p>Members</p>
            </div>
            <div class="col-md-2 col-6 stats-detail">
            ...
            <div class="section-popular-travel row justify-content-center">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card-travel text-center d-flex flex-column"
                        style="background-image: url('{{ $item->galleries->count() > 0 ? Storage::url($item->galleries->first()->image) : '' }}')">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 text-center">
                    <img src="frontend/images/partner.jpg" alt="Logo Partners" class="img-partner" />
                </div>
            </div>
        </div>
    </section>
