            ...
            <form action="{{ route('travel-package.update', $item->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="language" id="language" placeholder="Language"
                        value="{{ $item->language }}" class="form-control">
                </div>
                <div class="form-group">
                    <label for="foods">Foods</label>
                    <input type="text" name="foods" id="foods" placeholder="Foods" value="{{ $item->foods }}"
                        class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="duration" id="duration" placeholder="Duration"
                        value="{{ $item->duration }}" class="form-control">
                </div>
                <div class="form-group">
                    <label for="type">Type</label>
                    <input type="text" name="type" id="type" placeholder="Type" value="{{ $item->type }}"
                        class="form-control">
                </div>
                <div class="form-group">
                    <label for="price">Price</label>
                    <input type="number" name="price" id="price" placeholder="Price" value="{{ $item->price }}"
                        class="form-control">
                </div>
