            ...
            <form action="{{ route('travel-package.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="language" id="language" placeholder="Language"
                        value="{{ old('language') }}" class="form-control">
                </div>
                <div class="form-group">
                    <label for="foods">Foods</label>
                    <input type="text" name="foods" id="foods" placeholder="Foods" value="{{ old('foods') }}"
                        class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="type" id="type" placeholder="Type" value="{{ old('type') }}"
                        class="form-control">
                </div>
                <div class="form-group">
