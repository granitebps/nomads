                    ...
                    <div class="card card-details mb-3">
                        ...
                        <div class="gallery">
                            <div class="xzoom-container">
                                <img src="{{ Storage::url($item->galleries->first()->image) }}" alt="Nusa Penida"
                            ...
                            <div class="xzoom-thumbs">
                                ...
                                <a href="{{ Storage::url($gallery->image) }}">
                                    <img src="{{ Storage::url($gallery->image) }}" alt="Nusa Penida"
                        ...
                        <div class="features row">
                            <div class="col-md-4">
                                <img src="{{ asset('frontend/images/icon_event.png') }}" alt="Featured Event"
                            ...
                            <div class="col-md-4 border-left">
                                <img src="{{ asset('frontend/images/icon_bahasa.png') }}" alt="Language"
                                    class="features-image" />
                                <div class="description">
                                    <h3>Language</h3>
                                    <p>{{ $item->language }}</p>
                            ...
                            <div class="col-md-4 border-left">
                                <img src="{{ asset('frontend/images/icon_food.png') }}" alt="Foods"
                                    class="features-image" />
                                <div class="description">
                                    <h3>Foods</h3>
                                    <p>{{ $item->foods }}</p>
                        ...
                        <table class="trip-informations">
                            <tr>
                                ...
                                <td width="50%" class="text-right">
                                    {{ \Carbon\Carbon::parse($item->departure_date)->format('F n, Y') }}</td>
                            </tr>
                            <tr>
